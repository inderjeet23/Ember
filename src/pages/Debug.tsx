...
export default function DebugPage(){
  function seed(){
    const db = load()
    const p: Project = { id: id(), name: 'YouTube Short', type: 'video' as const, momentumScore: 60, state: 'warm' as const, createdAt: Date.now(), updatedAt: Date.now(), tasks: [], wins: [] }
    ...
    db.projects.unshift(p); save(db); location.reload()
  }
  return (
